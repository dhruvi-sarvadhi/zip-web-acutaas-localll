    ...
    <section className="overflow-hidden py-12 md:py-16 lg:py-20">
      <div className="main-container">
        <div className="flex flex-col gap-8 md:gap-10 lg:gap-14">
          <SectionHeader title="Intro section for R&D center" />
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 md:gap-5">
              ...
              <span className="text-[#968E90]">
                Our research ecosystem blends advanced analytical instruments with robust process
                development capabilities to accelerate discovery and scale-up with reliability.
              </span>
              </h3>
