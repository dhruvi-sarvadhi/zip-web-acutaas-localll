        ...
        <div className="flex flex-col gap-10 sm:gap-12 lg:gap-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <OurProductCard
              ...
              description="Built through deep research to meet global quality and regulatory needs for life changing medicines."
              image="/images/product-1.png"
            />
            <OurProductCard
              title="Specialty and Performance Chemicals"
              description="Engineered to uplift industrial applications with precision, reliability, and measurable value."
              image="/images/product-2.png"
            />
            <OurProductCard
              title="Advanced Battery Materials"
              description="Developed to power next generation energy storage with efficiency, purity, and lasting performance."
